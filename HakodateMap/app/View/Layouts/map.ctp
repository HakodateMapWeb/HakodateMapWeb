...
<body>
	<div id="container" class="clearfix">
		<div id="gnav">
			<ul>
				<li class="gnav01"><a href="../HakodateMap/Web/">TOP</a></li>
				<li class="gnav02"><a href="../HakodateMap/Web/about">ABOUT</a></li>
				<li class="gnav03"><a href="../HakodateMap/Web/courselist">COURSELIST</a></li>
